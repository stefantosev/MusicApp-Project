        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookStoreApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.BookStoreApplicationUserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookInOrders_Order_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Order",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookInOrders_Orders_OrderBookId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrackInOrder", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrackInOrder_Order_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Order",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrackInOrder_Track_TrackId",
                        column: x => x.TrackId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrackInPlaylist_Track_TrackId",
                        column: x => x.TrackId,
                        principalTable: "Track",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrackInPlaylist_UserPlaylist_UserPlaylistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookInOrders_OrderBookId",
                table: "BookInOrders",
                column: "OrderBookId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_BookStoreApplicationUserId",
                table: "Order",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrackInOrder_OrderId",
                table: "TrackInOrder",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_TrackInOrder_TrackId",
                table: "TrackInOrder",
                column: "TrackId");
